<template>
  <div class="flex flex-col items-center bg-gradient-to-r from-[#451952] via-[#451952] to-[#ae4188] shadow-custom m-5 p-5 rounded w-full h-full text-white">
    <div class="p-0 w-full m-0 text-center">
      ...
      <div class="bg-gradient-to-r from-[#662549] to-[#451952] flex flex-col items-center justify-between p-[10px] mt-[10px] rounded">
        <h2>Match History</h2>
        <ul class="history list-none p-0 w-[80%] text-center">
          <li v-for="(matchItem, index) in match" :key="index" class="shadow-third bg-gradient-to-r from-[#662549] to-[#ae445a] p-[10px] m-[5px] rounded">
