	...
	<div
		...
		<div class="flex-col items-center justify-between w-full lg:w-1/5 m-0 my-4">
			...
			<div
				...
				<ButtonComponent btnContent="Create Channel" class="m-2" @click="AddChannelForm" />
		...
		<div class="w-full lg:w-58 m-0">
			...
			<div
				...
				<div class="bg-white h-[420px] p-1 mb-5 m-1 text-black" style="text-align: right">
					<div v-for="(chatMessage, index) in chatMessage" :key="index">
						<div class="bg-gray-500 text-black py-2 px-4 inline-block m-1 mx-5 rounded-md"
